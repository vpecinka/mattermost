...
PLUGIN_PACKAGES="$PLUGIN_PACKAGES mattermost-plugin-gitlab-v1.12.3"
PLUGIN_PACKAGES="$PLUGIN_PACKAGES mattermost-plugin-zoom-v1.13.0"
PLUGIN_PACKAGES="$PLUGIN_PACKAGES mattermost-plugin-boards-v9.2.7"
